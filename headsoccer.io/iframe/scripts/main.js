...
window.RuntimeInterface = class a {
    ...
    async _Init(b) {
        ...
        b.runtimeBaseUrl
            ...
            : ((c = location.origin), (this._runtimeBaseUrl = ("null" === c ? "file:///" : c) + location.pathname), (c = this._runtimeBaseUrl.lastIndexOf("https://headsoccer.io/")), -1 !== c && (this._runtimeBaseUrl = this._runtimeBaseUrl.substr(0, c + 1)));
    ...
    _GetWorkerURL(b) {
        b = this._workerScriptURLs.hasOwnProperty(b)
            ...
            : b.endsWith("../workermain.html") && this._workerScriptURLs.hasOwnProperty("workermain.html")
        ...
        if ("cordova" === this._exportType)
            for (let g = 0, h = b.projectScripts.length; g < h; ++g) {
                const k = b.projectScripts[g],
                    l = k[0];
                if (l === b.mainProjectScript || "scriptsInEvents.js" === l || l.endsWith("../scriptsInEvents.html")) k[1] = await this._MaybeGetCordovaScriptURL(l);
            }
    ...
    async _InitDOM(b, c) {
        ...
        this._domHandlers = domHandlerClasses.map((g) => new g(this));
        this._FindRuntimeDOMHandler();
        var d = b.engineScripts.map((g) => ("string" === typeof g ? new URL(g%2c%20this.html).toString() : g));
        ...
        for (let [g, h] of f)
            ...
            else if ("scriptsInEvents.js" === g || g.endsWith("../scriptsInEvents.html")) (h = await this._MaybeGetCordovaScriptURL(h)), await AddScript(h);
...
self.JobSchedulerDOM = class {
    constructor(a) {
        ...
        "preview" === a.GetExportType() ? (this._baseUrl += "workers/index.html") : (this._baseUrl += a.GetScriptFolder());
    ...
    async Init() {
        ...
        var a = this._runtimeInterface._GetWorkerURL("dispatchworker.html");
    ...
    async _CreateJobWorker() {
        ...
        var b = this._runtimeInterface._GetWorkerURL("jobworker.html");
...
self.RuntimeInterface.AddDOMHandlerClass(
    class extends self.DOMHandler {
        ...
        _OnRequestFullscreen(a) {
            if ("windows-webview2" === this._exportType || "macos-wkwebview" === this._exportType) self.RuntimeInterface._SetWrapperIsFullscreenFlag(!0), this._iRuntime._SendWrapperMessage({ type: "set-fullscreen", fullscreen: !0 });
            else {
                ...
                a.requestFullscreen
                    ...
                    : a.webkitRequestFullScreen && ("undefined" !== typeof Element.ALLOW_KEYBOARD_INPUT ? a.webkitRequestFullScreen(Element.ALLOW_KEYBOARD_INPUT) : a.webkitRequestFullScreen());
            }
        }
        _OnExitFullscreen() {
            "windows-webview2" === this._exportType || "macos-wkwebview" === this._exportType
                ? (self.RuntimeInterface._SetWrapperIsFullscreenFlag(!1), this._iRuntime._SendWrapperMessage({ type: "set-fullscreen", fullscreen: !1 }))
...
self.RuntimeInterface.AddDOMHandlerClass(
    class extends self.DOMElementHandler {
        ...
        CreateElement(a, b) {
            ...
            c.addEventListener("click", () => this._PostToRuntimeElementMaybeSync("click", a, { isChecked: c.checked }));
            b.id && (c.id = b.id);
        ...
        _GetFocusElement(a) {
            return this._GetInputElem(a);
        }
        UpdateState(a, b) {
            const c = this._GetInputElem(a);
